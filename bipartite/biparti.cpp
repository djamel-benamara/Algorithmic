...
int main() {
	...
	g[6].push_back(2);
	g[6].push_back(3);
	cout << "Bipartite Graph manually generated :" << endl;
	afficher_g(g);
	cout << "------------" << endl;

	cout << "------------\n\n" << endl;
	cout << "Is the random graph bipartite ? " << endl;
	if(isBIP(gg))
		cout << "YES" << endl << endl;
	else
		cout << "NO" << endl << endl;
	cout << "------------ Second graph ------------" << endl << endl;
	cout << "Is the  manually generated graph bipartite ? " << endl << endl;
	if(isBIP(g))
		cout << "YES" << endl << endl;
	else
		cout << "NO" << endl << endl;
